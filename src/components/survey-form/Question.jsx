...
function Question(props) {
    const {survey,question,handleSubmit,handleBack,handleNext,isLastQuestion,currentQIndex,answers,handleOptionChange} = props
    return (
            ...
            <div className='w-[30rem] bg-zinc-900 rounded-md p-3 m-auto'>
                ...
                <div className=''>
                    {question.options.map((option,i)=>{
                        return (
                            <div className='ml-5' key={i}><Option question={question} handleOptionChange={handleOptionChange} answers={answers} option={option} /></div>
                        )
                    })}
                </div>
            </div>
